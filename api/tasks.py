...
# Tâche Celery pour démarrer un crawl
...
def run_scrapy_spider(self, spider_name: str):
    ...
    try:
        # Lancement du crawl avec Scrapy
        ...
        # Récupération du nombre d'items scrapés
        items_scraped = 0
        if result.stdout:
        ...
        # Mise à jour du statut du crawl
        self.update_state(
            state='SUCCESS',
            meta={
                'current': 100,
